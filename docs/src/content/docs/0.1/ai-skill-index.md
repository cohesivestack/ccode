...
* [Getting Started](/0.1/getting-started/)
* [Project Layout](/0.1/using-ccode/project-layout/)
* [Configuration](/0.1/reference/configuration/)
* [Wrapper & Versions](/0.1/using-ccode/wrapper-and-versions/)

For authoring a process:

* [Processes](/0.1/using-ccode/processes/)
* [Templates](/0.1/using-ccode/templates/)
* [Runtime API](/0.1/reference/runtime-api/)
* [Minimal Process](/0.1/cookbook/minimal-process/)

For OpenAPI generation:

* [OpenAPI Workflows](/0.1/using-ccode/openapi-workflows/)
...
* [Accelerators](/0.1/using-ccode/accelerators/)
* [Accelerator States](/0.1/reference/accelerator-states/)
* [Accelerated Artifact](/0.1/cookbook/accelerated-artifact/)
* [CLI](/0.1/reference/cli/)
