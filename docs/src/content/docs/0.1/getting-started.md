...
description: Install Cohesive Code, initialize a workspace, and run a first
  TypeScript process.
...
* Read [Project Layout](/0.1/using-ccode/project-layout/) before building a real workspace.
* Read [Processes](/0.1/using-ccode/processes/) for the TypeScript process contract.
* Read [Accelerators](/0.1/using-ccode/accelerators/) before generating files that should be adjusted by a person or agent.
* Read [AI Skill Index](/0.1/ai-skill-index/) if you are preparing a skill or agent workflow.
